...
public class EditNowAboutBox extends javax.swing.JDialog {

    public EditNowAboutBox(java.awt.Frame parent) {
        super(parent);
        initComponents();
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(editnow.EditNowApp.class).getContext().getResourceMap(EditNowAboutBox.class);
        setTitle(resourceMap.getString("title")); // NOI18N
        setModal(true);
        setName("aboutBox"); // NOI18N
        setResizable(false);

        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(editnow.EditNowApp.class).getContext().getActionMap(EditNowAboutBox.class, this);
